...
const DeleteShopPage = () => {
    ...
    return (
        ...
        <div className="delete-shop-wrapper d-flex justify-content-center align-items-center" style={{ backgroundImage: `url(${AdminBG})` }}>
            <div className="card p-4 shadow-lg rounded-4" style={{ maxWidth: '500px', width: '100%', opacity: 0.9 }}>
